    ...
    <div>
        ...
        <div class="jumbotron">
            <form @submit.prevent="addPizza()" class="mb-5">
                ...
                <div class="form-group">
                    <strong><label for="pizzatype"> Choose pizza type: </label></strong>
                    <select class="form-control" id="pizzatype" v-model="pizza.type">
                        <option value="" selected> Select pizza type ... </option>
                        <option v-for="pizzatype in pizzatypes" v-bind:key="pizzatype.type" v-bind:value="pizzatype.value"> {{ pizzatype.type }} </option>
                    </select>
                </div>

                <div class="form-group">
                    <strong><label for="pizzabase"> Choose base type: </label></strong>
                    <select class="form-control" id="pizzabase" v-model="pizza.crust">
                        <option value="" selected>Select crust ... </option>
                        <option v-for="pizzacrust in pizzacrusts" v-bind:key="pizzacrust.crust" v-bind:value="pizzacrust.value"> {{ pizzacrust.crust }} </option>
                    </select>
                </div>
        ...
        <div v-for="pizza in pizzas" v-bind:key="pizza.id" class="card card-body mb-3">
            ...
            <p style="text-align: right;">
                ...
                <!-- <button class="btn btn-outline-primary" data-toggle="modal" data-target="#editpizzaorder" @click="editPizza(pizza)"> Edit </button> -->
                <!-- <button class="btn btn-outline-primary" data-toggle="modal" @click="editPizza(pizza)"> Edit </button> -->

                <!-- Modal -->
                <!-- <div class="modal fade" id="editpizzaorder" tabindex="-1" role="dialog" aria-labelledby="editpizzaorderLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editpizzaorderLabel">Edit Pizza Order</h5>
                    ...
                    <div class="modal-body"> -->
                        ...
                        <!-- <form @submit.prevent="addPizza()" class="mb-5"> -->
                        <!-- <form @submit="editPizza" class="mb-5">
                            <div class="form-group">
                                 <strong><label for="customername"> Customer Name: </label></strong>
                                <input class="form-control" placeholder="Customer Name" v-model="pizza.customer_name">
                            </div>
